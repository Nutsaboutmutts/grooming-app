...
const FAQS = [
  ...
  { q: "Do you take walk-ins?", a: "Nail trims are always walk-in — no appointment needed, just stop by during business hours! Baths and grooms are by appointment so every pup gets our full attention. Book online or give us a call." },
    ...
    <section className="section pricing" id="pricing">
      <div className="section-inner">
        ...
        <div className="addons">
          ...
          <p className="addons-walkin">💅 Nail trims are always walk-in — no appointment needed, just stop by!</p>
